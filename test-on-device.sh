...
echo "2. Test with RTSP stream:"
echo "   $FFMPEG_BIN -c:v h264_rkmpp -rtsp_transport tcp -i rtsp://192.168.1.95:554/live/0 -f null -"
echo "3. Encode from camera to file:"
echo "   $FFMPEG_BIN -c:v h264_rkmpp -rtsp_transport tcp -i rtsp://192.168.1.95:554/live/0 -t 30 -c:v copy /tmp/recording.mp4"
echo ""
